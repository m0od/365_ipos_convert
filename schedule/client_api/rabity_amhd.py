...
class RABITY_AMHD(object):

    def __init__(self):
        self.ADAPTER_RETAILER = 'rabity_aeonhd'
        ...
        self.DOMAIN = 'tanphu'
        self.BRANCH_ID = None
        self.USER = 'ketoan.aeonhadong'
        self.PASSWORD = 'Ketoan123'
...
if __name__:
    ...
    # now = datetime.now()
    # RABITY_AMHD().get_data(datetime.now() - timedelta(days=6), datetime.now())

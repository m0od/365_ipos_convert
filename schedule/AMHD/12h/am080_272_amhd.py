...
class AM080(object):
    def __init__(self):
        ...
        self.ADAPTER_RETAILER = '361_amhd'
        self.ADAPTER_TOKEN = '6b1a4ebb9bc5927a8c18951bb637ac2e0d8a2caca535507a73195c1b226fe489'
        self.FOLDER = '272_amhd'
    ...
    def get_data(self):
        ...
        for DATA in files:
            ...
            for i in range(1, nRows):
                ...
                total = get_value(rec.get('THANH TIEN CK').value)
                # print(code, total)
                discount = get_value(rec.get('GIAM GIA CHI TIET').value)
                discount += get_value(rec.get('GIAM GIA PHAN BO').value)

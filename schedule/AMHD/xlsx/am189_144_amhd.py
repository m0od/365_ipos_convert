...
class AM189(object):
    def __init__(self):
        ...
        self.ADAPTER_RETAILER = 'tasaki_bbq_amhd'
        self.ADAPTER_TOKEN = 'ad73f22a8e91e1cb9acac96bf12f34980ddc0460dfd8f2ddefccb7f9da4509cb'
        self.FOLDER = '144_amhd'
        self.FULL_PATH = f'/home/{self.FOLDER}/'
        self.DATE = datetime.now() - timedelta(days=1)
        self.EXT = f'{self.DATE.strftime("%d%m%Y")}*.xlsx'
        self.GG = Google()
        self.GG.FOLDER_ID = '1s-ACtTgNncsEl5wgUwtCS6ADIRxk69ll'
